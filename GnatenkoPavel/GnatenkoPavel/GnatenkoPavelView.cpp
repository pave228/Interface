...
void CGnatenkoPavelView::OnDraw(CDC* pDC)
{
	...
	/*pDC->MoveTo(10 + displ, 300);
	pDC->LineTo(40 + displ, 250);
	pDC->LineTo(70 + displ, 300);
	pDC->LineTo(10 + displ, 300);


	pDC->MoveTo(10 + displ, 300);
	pDC->LineTo(10 + displ, 350);
	pDC->LineTo(70 + displ, 350);
	pDC->LineTo(70 + displ, 300);


	pDC->Ellipse(15 + displ, 350, 65 + displ, 400);*/
